...
export default function ReviewForm({toggle,modal,review,setReview,rating,setRating,setAddReview,addReview}) {
          ...
          <div className="inputbox mt-3">
            <div className="star-rating">
              <FormGroup className="d-flex gap-4 align-items-center pb-3 pt-3">
                ...
                <div style={{fontSize:"25px"}} className="d-flex gap-3  align-items-center">
                  {renderStars()}
                </div>
              </FormGroup>
            </div>
